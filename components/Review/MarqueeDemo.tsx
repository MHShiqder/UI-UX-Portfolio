...
export function MarqueeDemo() {
  ...
  // Generate reviews only on the client
  useEffect(() => {
  ...
  useEffect(() => {
    if (!isTypingActive || reviews.length === 0) return;
  ...
  }, [isTypingActive, reviews]);

  if (reviews.length === 0) return null; // wait until client has generated reviews
  ...
  return (
    <div className="relative   flex w-full flex-col items-center justify-center overflow-hidden py-20">
      ...
      <div className="relative w-full max-w-7xl mx-auto">
        ...
        {/* Gradient overlays */}
        <div className="pointer-events-none absolute inset-y-0 left-0 w-1/4 bg-gradient-to-r from-white dark:from-gray-900 to-transparent z-10"></div>
        <div className="pointer-events-none absolute inset-y-0 right-0 w-1/4 bg-gradient-to-l from-white dark:from-gray-900 to-transparent z-10"></div>
      </div>
