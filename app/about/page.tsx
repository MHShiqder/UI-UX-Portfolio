...
import TeamMemberSection from "@/components/teamMember/teamMember";
  ...
  const approachItems = [
    {
      ...
      description:
        "Tailored interfaces crafted for your unique business objectives and audience needs, ensuring perfect alignment with your brand identity.",
      icon: <FiUsers className="text-gold-500 text-3xl" />,
    },
    {
      title: "Strategic Innovation",
      description:
        "Data-driven design decisions that deliver measurable business impact through rigorous user research and testing methodologies.",
      icon: <FiLayers className="text-gold-500 text-3xl" />,
    },
    {
      title: "Technical Mastery",
      description:
        "Flawless execution across all platforms and devices with pixel-perfect attention to detail and cutting-edge technologies.",
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              <div className="mb-10">
                ...
                <h2 className="text-4xl font-bold mb-6 dark:text-white font-serif mt-2">
                  Founder&apos;s Vision
                </h2>
      ...
      <section className="py-28 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl font-bold mb-4 dark:text-white font-serif mt-3">
