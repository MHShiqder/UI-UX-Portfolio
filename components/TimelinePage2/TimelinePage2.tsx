...
const timelineData: TimelineItemData[] = [
  ...
  },
  {
    ...
    icon: Code,
    responsibilities: [
      "Lead backend development of complex web applications with Node.js, Express, and TypeScript.",
      "Architect scalable server-side solutions and RESTful APIs using modern backend technologies.",
      "Mentor junior developers and conduct code reviews to ensure clean, maintainable code.",
      "Collaborate with frontend and design teams to deliver high-quality, performant products.",
    ],
...
export default function TimelinePage2() {
  return (
    <div className="transition-colors duration-300 pt-20">
      <div className="text-center relative z-10 mb-10">
        <ShinyButton>Experience</ShinyButton>
        <SectionTitle
          heading="Crafting Impactful Digital Experiences"
          subHeading="Proficient in UI/UX design and web development, I leverage creative design and modern technologies to build engaging, user-friendly interfaces"
        />
      </div>
