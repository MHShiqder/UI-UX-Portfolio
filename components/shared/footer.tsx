...
const Footer = () => {
  ...
  // Hover-safe objects for TypeScript
  // const iconHover = {
  //   scale: 1.1,
  ...
  // const colorHover = {
  //   color: "#a78bfa",
  //   transition: { color: { type: "tween", duration: 0.2 } },
  // };
  // const linkHover = {
  //   x: 3,
  //   transition: { x: { type: "spring", stiffness: 300, damping: 15 } },
  // };
  ...
  const handleHoverEnd = () => {
    setIsHovering(null);
    controls.start({ opacity: 0, y: 5, transition: { duration: 0.15 } });
  };

  return (
    <footer className="relative w-full px-4 md:px-8 lg:px-12 pb-10 transition-colors duration-300 overflow-hidden pt-[700px]">
      {/* Background video */}
      <video
        autoPlay
        loop
      ...
      >
        <source
          src="https://github.com/MHShiqder/globe-video/raw/refs/heads/main/video/footer_globe%20(1).mp4"
          type="video/mp4"
        />
      </video>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="flex gap-2 pt-1">
              {socialLinks.map((social, i) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="relative p-1.5 text-gray-500 dark:text-gray-500 transition-colors"
          ...
          <motion.div variants={item} className="space-y-4">
            ...
            <div className="space-y-2">
              {["Home", "Work", "Services", "About", "Blog", "Contact"].map(
                (link, i) => (
                  <motion.div
                    key={link}
            ...
            <div className="grid grid-cols-2 gap-2">
              {services.map((service, i) => (
                <motion.div
                  ...
                  whileHover={{
                    x: 3,
                    transition: { x: { type: "spring", stiffness: 300 } },
                  }}
