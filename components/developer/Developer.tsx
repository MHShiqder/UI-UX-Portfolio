...
const Developer = () => {
  ...
  return (
    <div className="h-[750px] w-full bg-white dark:bg-gray-950 transition-colors duration-500 overflow-hidden  py-20">
      <motion.div 
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row items-center  gap-8 relative z-10 h-full">
          ...
          >
            <div className="relative h-full w-full overflow-hidden rounded-2xl shadow-xl border-2 border-gray-200/50 dark:border-gray-700/50">
              <Image
                ...
                fill
                className="object-cover object-top grayscale-[15%] group-hover:grayscale-0 transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)]"
                quality={100}
                priority
              />
          ...
          <div className="w-full lg:w-3/5 space-y-4 h-full flex flex-col justify-center overflow-y-auto">
